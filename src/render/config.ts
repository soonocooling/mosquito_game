...
/** 신규 부기 반경 (faceW) */
export const BITE_RADIUS_INIT = 0.12;
/** 부기 반경 상한 (faceW) */
export const BITE_RADIUS_MAX = 0.5;
/** 병합 시 반경 배율 */
export const BITE_RADIUS_GROW = 1.1;

/** 신규 부기 목표 세기 */
export const BITE_STRENGTH_INIT = 0.25;
/** 병합 시 목표 세기 증가량 */
export const BITE_STRENGTH_STEP = 0.15;
/** 목표 세기 상한 */
export const BITE_STRENGTH_MAX = 0.6;
...
export const SWELL_MUL: readonly [number, number, number] = [1.0, 0.55, 0.55];
export const SWELL_ADD: readonly [number, number, number] = [0.15, 0.0, 0.0];
/** 붉은 기 누적 상한 */
export const RED_MAX = 0.8;
